...
plugins: libs
	$(MAKE) all -C plugins/stereocrossdelay
...
lv2lint:
	$(MAKE) lv2lint -C plugins/stereocrossdelay

# --------------------------------------------------------------

clean:
	$(MAKE) clean -C dpf/utils/lv2-ttl-generator
	$(MAKE) clean -C plugins/stereocrossdelay
	rm -rf bin build

install: all
	$(MAKE) install -C plugins/stereocrossdelay

install-user: all
	$(MAKE) install-user -C plugins/stereocrossdelay
